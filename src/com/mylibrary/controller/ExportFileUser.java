...
public class ExportFileUser {
    public void ExportFileWord(JTable table,String fileName) {
        try {
            ...
            try ( //Bước 1: Khởi tạo đối tượng để sinh ra file word
                ...
                tableRowOne.addNewTableCell().setText(" MÃ NHÂN VIÊN ");
                tableRowOne.addNewTableCell().setText(" HỌ VÀ TÊN ");
                tableRowOne.addNewTableCell().setText(" TÀI KHOẢN ");
                tableRowOne.addNewTableCell().setText(" SỐ ĐIỆN THOẠI ");
                tableRowOne.addNewTableCell().setText(" CHỨC VỤ");
    ...
    public void ExportFileWordByRole(JTable table,String fileName) {
